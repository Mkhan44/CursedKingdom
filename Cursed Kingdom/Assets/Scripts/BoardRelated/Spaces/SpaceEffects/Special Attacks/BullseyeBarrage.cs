...
public class BullseyeBarrage : SpecialAttackSpace, ISpaceEffect
{
    ...
    public override void EffectOfSpace(Player playerReference)
    {
        ...
        //Needs to go through a list of all other characters and deal damage to each of them simultaneously.
        Debug.Log($"Landed on: {this.name} special attack space. Discard {NumCardsToDiscard} {CardTypeToDiscard}(s) to deal {DamageToDeal} damage to all opponents.");
    }
}
