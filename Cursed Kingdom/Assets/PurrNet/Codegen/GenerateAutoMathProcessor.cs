...
namespace PurrNet.Codegen
{
    public static class GenerateAutoMathProcessor
    {
        ...
        public static void HandleType(TypeDefinition type, TypeReference math, TypeReference interf,
            List<DiagnosticMessage> messages)
        {
            ...
            if (!type.IsValueType)
            {
                ...
                {
                    MessageData =
                        $"Type `{type.FullName}` is a class and cannot be used as a math type, please use a struct instead.",
