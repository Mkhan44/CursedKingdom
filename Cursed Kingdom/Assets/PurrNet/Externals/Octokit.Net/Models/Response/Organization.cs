...
namespace Octokit
{
    ...
    public class Organization : Account
    {
        ...
        public Organization(string avatarUrl, string bio, string blog, int collaborators, string company,
            ...
            string htmlUrl, int totalPrivateRepos, long id, string nodeId, string location, string login, string name,
            int ownedPrivateRepos, Plan plan, int privateGists, int publicGists, int publicRepos, string url,
            string billingAddress, string reposUrl, string eventsUrl, string hooksUrl, string issuesUrl,
            string membersUrl, string publicMembersUrl, string description, bool isVerified,
            bool hasOrganizationProjects, bool hasRepositoryProjects, DateTimeOffset updatedAt)
            : base(avatarUrl, bio, blog, collaborators, company, createdAt, diskUsage, email, followers, following,
                ...
                privateGists, publicGists, publicRepos, AccountType.Organization, url)
        {
