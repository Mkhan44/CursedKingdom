...
namespace Octokit
{
    ...
    {
        public RepositoryContentLicense(LicenseMetadata license, string name, string path, string sha, int size,
            ContentType type, string downloadUrl, string url, string gitUrl, string htmlUrl)
        ...
        internal new string DebuggerDisplay
        {
            get
            {
                return string.Format(CultureInfo.InvariantCulture, "License: {0} {1}", this.License?.Key,
