...
namespace Octokit
{
    ...
    public enum CheckConclusion
    {
        ...
        [Parameter(Value = "neutral")] Neutral,

        [Parameter(Value = "cancelled")] Cancelled,

        [Parameter(Value = "timed_out")] TimedOut,

        [Parameter(Value = "action_required")] ActionRequired,

        [Parameter(Value = "skipped")] Skipped,

        [Parameter(Value = "stale")] Stale,
    }

    public enum CheckAnnotationLevel
    {
        [Parameter(Value = "notice")] Notice,

        [Parameter(Value = "warning")] Warning,
