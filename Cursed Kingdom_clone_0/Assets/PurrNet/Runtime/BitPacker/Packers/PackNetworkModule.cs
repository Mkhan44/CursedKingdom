...
namespace PurrNet
{
    public static class PackNetworkModule
    {
        ...
        [UsedByIL]
        public static void WriteIdentityConcrete(this BitPacker packer, NetworkModule module) => WriteModule(packer, module);

        [UsedByIL]
        public static void ReadIdentityConcrete(this BitPacker packer, ref NetworkModule module) => ReadModule(packer, ref module);
    }
}
