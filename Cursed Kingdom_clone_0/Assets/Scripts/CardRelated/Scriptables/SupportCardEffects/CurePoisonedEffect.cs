...
/// <summary>
/// This support card effect is used to cure the 'poisoned' status from a Player.
/// </summary>

[CreateAssetMenu(fileName = "CurePoisonedEffect", menuName = "Card Data/Support Card Effect Data/Cure Poisoned Effect", order = 0)]
public class CurePoisonedEffect : SupportCardEffectData, ISupportEffect
{
